                                ...
                                <div class="card">
                                    ...
                                    <div class="card-overlay">
                                        <div class="card-actions">
                                            <a href="{{ route('showcar', ['id' => $car->id]) }}" class="btn btn-primary btn-sm mr-2">View</a>
                                            <a href="{{ route('editcar', ['id' => $car->id]) }}" class="btn btn-primary btn-sm mr-2">Edit</a>
                                            <form method="POST" action="{{ route('deletecar', ['id' => $car->id]) }}" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
